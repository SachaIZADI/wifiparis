...
#'
#' @param start = a POSIXct, end = a POSIXct, duration_max = an int (default is 7200), districts, = a vector (default is c("All")) , cat_sites = idem, sites = idem, countries = idem, devices = idem
